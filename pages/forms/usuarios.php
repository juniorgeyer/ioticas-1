      ...
      <div class="row mb-2">
        <div class="card col-md-12">
          <div class="card-header">
            <button class="btn btn-primary" onclick="window.location.href='cadastro_usuario.php'"><i class="fas fa-plus"></i>Novo usuário</button>
          </div>
          <!-- /.card-header -->
          ...
          <div class="card-body">
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr>
                <td></td>
                <td>Rodolfo</td>
                <td>junior_geyer@hotmail.com</td>
